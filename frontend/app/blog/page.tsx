...
export const metadata: Metadata = {
  ...
  description: "Weekly Pokemon TCG sealed product price movements, booster box investment analysis and collector guides. Data-driven insights updated monthly.",
  keywords: [
    ...
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-slate-400">Price movers, investment analysis and guides for Pokemon TCG sealed products. Updated monthly.</p>
        </div>
